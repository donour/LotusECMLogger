...
namespace LotusECMLogger
{
    ...
    public class T6eCodingDecoder
    {
        ...
        [
            ...
            new CodingOption(54, 7, "Traction Control Level", ["None", "Basic", "TC + Drag Torque Control", "ESP"]),
            new CodingOption(53, 1, "Mechanical LSD Installed", FALSE_TRUE),
            ...
            new CodingOption(44, 1, "Supplemental Restraint System (Airbig)", FALSE_TRUE),
            ...
            new CodingOption(31, 1, "Race Button", FALSE_TRUE),
            ...
            new CodingOption(20, 1, "Recirc Value", FALSE_TRUE),
            new CodingOption(19, 1, "Manual Transmission Fluid Pump", FALSE_TRUE),
            new CodingOption(18, 1, "Fuel Pump Type", ["Relay", "PWM"]),
