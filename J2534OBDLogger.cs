...
namespace LotusECMLogger
{
    internal class J2534OBDLogger
    {
        ...
        {
            this.output_filename = $"C:\\Users\\donou\\LotusECMLog_{DateTime.Now:yyyyMMdd_HHmmss}.csv";
        }
        ...
        public void connect()
        {
            if (isConnected)
            {
                throw new InvalidOperationException("Already connected to OBD-II device.");
            }
